...
export const portfolio = {
  ...
  background: 'I completed a five-year MSc in Data Science at NMBU (2021–2026), specialising in Business Analytics. My master’s thesis explored predictions from lung CT scans. Alongside my studies, work in healthcare and hospitality taught me to collaborate, communicate clearly, and stay calm when things get busy.',
  skills: [
  ...
  projects: [
    ...
    },
    {
      ...
      summary: [{"label": "Purpose", "text": "Explore energy production, consumption and weather across Norway’s five electricity price areas."}, {"label": "My contribution", "text": "Rebuilt the dashboard with Next.js and FastAPI, combining Elhub and Open-Meteo data with regional analysis and forecast evaluation."}],
      ...
      status: 'Completed',
      tags: ['Next.js', 'FastAPI', 'Python', 'Time series', 'Forecasting', 'Visualisation', 'Data validation'],
    },
    {
