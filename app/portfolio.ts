...
export const portfolio = {
  ...
  projects: [
    ...
    },
    {
      ...
      summary: [{"label": "Purpose", "text": "Explore Norwegian energy production, consumption, weather and regional patterns in one dashboard."}, {"label": "My contribution", "text": "Built a Next.js dashboard with a FastAPI backend, covering exploration, regional analysis, diagnostics and forecast evaluation."}],
      details: [{"label": "Dashboard", "text": "The current application brings together energy production and consumption across Norway’s price areas, weather exploration and regional views."}, {"label": "Analysis", "text": "It includes correlation and decomposition tools, spectral and data-quality views, snow drift analysis and forecast benchmarks with uncertainty metrics."}, {"label": "Delivery", "text": "I built the current dashboard with Next.js and FastAPI, with transparent methods, data freshness and provenance built into the workflow."}],
      detailLabel: "View analysis details",
      url: 'https://github.com/TaoM29/norwegian-energy-dashboard',
      ...
      description: 'I built a Norwegian energy and weather dashboard with Next.js and FastAPI. It brings together production and consumption across regional price areas, weather and regional analysis, diagnostics, snow drift views, and forecast evaluation with uncertainty metrics.',
      status: 'Completed',
      tags: ['Streamlit', 'Time series', 'Forecasting', 'Visualisation', 'Data collection', 'Data validation', 'Seasonal analysis'],
    },
    {
